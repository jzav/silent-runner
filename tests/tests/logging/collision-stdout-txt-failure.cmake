...
sr_test_init(DESCRIPTION "Refuses stdout TXT logging with exit code 255 when the failure candidate already exists, without overwriting it or starting the child.")

set(log_dir "${SR_TEST_ROOT}/logs")
set(execution_id "ctest-collision-stdout-txt-failure")
set(collision_log "${log_dir}/${execution_id}_stdout_failure.log")
