...
sr_test_init(DESCRIPTION "Rejects an unknown JSONL payload representation before the child process is started.")
...
sr_run(r ARGS
    --jsonl-payload-representation invalid-representation
    "${child_cmd}"
)
...
sr_assert_stderr_contains(
    r
    "Invalid value for --jsonl-payload-representation. Allowed values:"
)
