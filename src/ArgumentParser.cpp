...
std::wstring BuildUsageText() {
    std::wstring err =
        ...
        L"      SILENTRUNNER_STDOUT_LOG, SILENTRUNNER_STDERR_LOG,\n"
        L"      SILENTRUNNER_STDERR_CHILD_LOG, SILENTRUNNER_STDERR_SR_LOG.\n"
        ...
        L"      The execution ID is formed as:\n"
        L"      id-prefix + id-base + id-suffix.\n"
        L"      Default is timestamp+pid (UTC).\n"
        L"\n"
